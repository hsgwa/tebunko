@echo off
rem tebunko launcher (search and compare Office files).
...
start "" powershell -NoProfile -STA -ExecutionPolicy RemoteSigned -WindowStyle Hidden -File "%~dp0scripts\tebunko\gui.ps1"
