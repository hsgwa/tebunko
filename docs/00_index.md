...
| [05_制限モード.md](05_制限モード.md) | `tebunko_grep.bat`（いつもの画面を開けない PC） | `tebunko_grep/start.ps1` / `tebunko_grep/restricted/` | 制限言語モード（AppLocker・WDAC）の PC で使うコンソールの版。検索と、結果の Excel のブック |
