...
| [05_制限モード.md](05_制限モード.md) | `tebunko_grep.bat`（いつもの画面を開けない PC） | `tebunko_grep/start.ps1` / `tebunko_grep/restricted/` | 制限言語モード（AppLocker・WDAC）の PC で使うコンソールの版。検索・結果の Excel のブック・インデックスの作成 |
| └ [05_制限モード_1_管理者向け.md](05_制限モード_1_管理者向け.md) | – | – | 管理者向けの案内（AppLocker・WDAC のパス規則、実行ポリシー、共有フォルダとゾーン、確かめること） |
